...
const createEvent = {
  ...
  query: `mutation createEvent($name: String!, $host: String!, $type: String!, $place: String!, $time: String!, $date: String!, $details: String!) {
    createEvent(name: $name, host: $host, type: $type, place: $place, time: $time, date: $date, details: $details) {
      ${lightEvent}
    }
}`,
};
const editEvent = {
  ...
  query: `mutation editEvent($name: String!, $host: String!, $type: String!, $place: String!, $time: String!, $date: String!, $details: String!, $eventId: String!) {
    editEvent(name: $name, host: $host, type: $type, place: $place, time: $time, date: $date, details: $details, eventId: $eventId) {
      ${lightEvent}
    }
}`,
};
